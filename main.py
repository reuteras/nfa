...
async def get_rootid(
    input_id: str,
    iso_start: str = "1970-01-01T00:00:00.000Z",
    iso_stop: str = "2100-12-31T23:59:59.000Z",
    node: str = "node",
):
...
async def get_visual_rootid(
    input_id: str,
    iso_start: str = "1970-01-01T00:00:00.000Z",
    iso_stop: str = "2100-12-31T23:59:59.000Z",
    node: str = "default-arkime-node",
):
